...
#' We want to visualize the relationships between the samples (within and across the tissue and time), and then we want to perform statistical
#'  tests to find which genes are changing their expression due to tissue and developmental time.
#' 
